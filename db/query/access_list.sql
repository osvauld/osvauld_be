...
SELECT DISTINCT u.id, u.username, u.name, u.rsa_public_key as "publicKey"
FROM users u
...
SELECT users.id, users.username, users.name, users.rsa_public_key as "publicKey", access_list.access_type as "accessType"
FROM access_list
